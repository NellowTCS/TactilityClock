...
const esp_elfsym main_symbols[] {
    ...
    ESP_ELFSYM_EXPORT(LV_SYMBOL_WIFI),
    ESP_ELFSYM_EXPORT(LV_SYMBOL_REFRESH),
    ESP_ELFSYM_EXPORT(LV_RADIUS_CIRCLE),
    ESP_ELFSYM_EXPORT(LV_PCT),
    ESP_ELFSYM_EXPORT(LV_SIZE_CONTENT),
    ESP_ELFSYM_EXPORT(LV_TEXT_ALIGN_CENTER),
    ESP_ELFSYM_EXPORT(LV_ALIGN_TOP_MID),
    ESP_ELFSYM_EXPORT(LV_ALIGN_OUT_BOTTOM_MID),
    ESP_ELFSYM_EXPORT(LV_ALIGN_BOTTOM_MID),
    ESP_ELFSYM_EXPORT(LV_ALIGN_RIGHT_MID),
    ESP_ELFSYM_EXPORT(LV_ALIGN_CENTER),
    ESP_ELFSYM_EXPORT(LV_OBJ_FLAG_HIDDEN),
    ESP_ELFSYM_EXPORT(LV_OBJ_FLAG_SCROLLABLE),
    ESP_ELFSYM_EXPORT(LV_OPA_10),
    ESP_ELFSYM_EXPORT(LV_OPA_30),
    ESP_ELFSYM_EXPORT(LV_OPA_50),
    ESP_ELFSYM_EXPORT(LV_OPA_80),
    ESP_ELFSYM_EXPORT(LV_OPA_COVER),
    ESP_ELFSYM_EXPORT(LV_EVENT_CLICKED),
    // lv_display
